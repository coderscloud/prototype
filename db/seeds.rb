...
PrProjectType.find_or_create_by_ptype(:ptype => 'Site Web', :image_path => "<img src='/images/web.png' />")
PrProjectType.find_or_create_by_ptype(:ptype => 'Application mobile', :image_path => "<img src='/images/mobile.png' />")
